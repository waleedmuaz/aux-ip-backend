...
//        dd($columns);
    ...
    public function formDataSubmit(FashionCompanyRequest $request){
        $data=[
            ...
            "application_filing_date"=>date('F d Y', strtotime($request->application_filing_date)),
            "patent_numbers"=>$request->patent_numbers,
            "grant_date"=>date('F d Y', strtotime($request->grant_date)),
            "country"=>$request->country,
            "due_date"=>date('F d Y', strtotime($request->due_date)),
            "last_instruction_date"=>date('F d Y', strtotime($request->last_instruction_date)),
